...
import {
    AppBar, Toolbar, IconButton, Typography, Switch, Drawer, List, ListItem, ListItemText, Divider,
    Link as MuiLink, useMediaQuery, Button
} from '@mui/material';
            ...
            <Toolbar sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                {!isSmallScreen && (
                    <div style={{ display: 'flex', justifyContent: 'center', flexGrow: 1, gap: '20px' }}>
                        <MuiLink href="#hero" color="inherit" underline="none">
                            Home
                        </MuiLink>
                        <MuiLink href="#profile" color="inherit" underline="none">
                            Profile
                        </MuiLink>
                    </div>
                )}
            ...
            >
                <div style={{ width: 240, display: 'flex', flexDirection: 'column', height: '100%' }}>
                    ...
                    <List style={{ flexGrow: 1 }}>
                        ...
                        <ListItem onClick={() => handleLinkClick('/admin-profile')} >
